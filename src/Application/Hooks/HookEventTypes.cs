...
public class CustomerMutationHookEvent
{
    ...
    public required string OccurredAt
    {
        get; init;
    }
    ...
    public CustomerDto? Old
    {
        get; init;
    }
    public CustomerDto? New
    {
        get; set;
    }
}
...
public class SubscriptionMutationHookEvent
{
    ...
    public SubscriptionDto? Old
    {
        get; init;
    }
    public SubscriptionDto? New
    {
        get; set;
    }
